...
UserTerminal.InitGrid = function (jcdbh) {
    grid = $('#list_data').datagrid({
        ...
        rownumbers: true,  //行号
        columns: [[
          { field: 'terminalNum', title: '出场设备编号',align: 'center', width: 50 },
          { field: 'RID', title: 'MCU编号（RID）',align: 'center', width: 100 },
          { field: 'TNS', title: '测站编号',align: 'center', width: 50 },   
          { field: 'User', title: '所属用户',align: 'center', width: 50 },
          ...
          { field: 'id', title: '操作', width: 30, align: 'center', formatter: formatOper }
...
UserTerminal.InitGridterminal = function(jcdbh){
