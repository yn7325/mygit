...
! function(t) {
    ...
    r.prototype.cache = n, r.prototype.define = function(t, e) {
        ...
        function s(t, e) {
            ...
            ("load" === t.type || r.test((t.currentTarget || t.srcElement).readyState)) && (n.modules[v] = e, d.removeChild(g), function o() { return ++h > 1e3 * n.timeout / 4 ? i(v + " is not a valid module", "error") : void(n.status[v] ? p() : setTimeout(o, 4)) }())
        }

        function p() { o.push(layui[v]), t.length > 1 ? f.use(t.slice(1), r, o, c) : "function" == typeof r && function() { return layui.jquery && "function" == typeof layui.jquery && "define" !== c ? layui.jquery(function() { r.apply(layui, o) }) : void r.apply(layui, o) }() }
        var f = this,
        ...
        if (m = m.replace(/^\{\/\}/, ""), !n.modules[v] && layui[v] && (n.modules[v] = m), n.modules[v]) ! function b() { return ++h > 1e3 * n.timeout / 4 ? i(v + " is not a valid module", "error") : void("string" == typeof n.modules[v] && n.status[v] ? p() : setTimeout(b, 4)) }();
        else {
    ...
    }, r.prototype.hint = function() { return { error: i } }, r.prototype.each = function(t, e) {
        var n, r = this,
...
! function() {
    ...
    r.prototype = [], r.prototype.constructor = r, n.extend = function() {
        ...
        c.rel = "stylesheet", c.href = t, c.id = a, e.getElementById(a) || i.appendChild(c), "function" == typeof r && ! function f(t) {
            ...
            return ++l > 1e4 / o ? window.console && console.error(u + ".css: Invalid") : void(1989 === parseInt(n.getStyle(i, "width")) ? (t === s && i.removeAttribute("lay-status"), i.getAttribute("lay-status") === s ? setTimeout(f, o) : r()) : (i.setAttribute("lay-status", s), setTimeout(function() { f(s) }, o)))
        }()
...
! function(e) {
    ...
    var t = e.layui && layui.define,
        a = { getPath: e.lay && lay.getPath ? lay.getPath() : "", link: function(t, a, n) { i.path && e.lay && lay.link && lay.link(i.path + t, a, n) } },
        n = e.LAYUI_GLOBAL || {},
        i = {
            v: "5.3.0",
            config: {},
        ...
        l = function() {
            var e = this,
                t = e.config,
                a = t.id;
            return l.that[a] = e, { hint: function(t) { e.hint.call(e, t) }, config: e.config }
        },
        r = "laydate",
        o = ".layui-laydate",
        s = "layui-this",
        ...
        T = function(e) {
            var t = this;
            t.index = ++i.index, t.config = lay.extend({}, t.config, i.config, e), e = t.config, e.id = "id" in e ? e.id : t.index, i.ready(function() { t.init() })
        },
        D = "yyyy|y|MM|M|dd|d|HH|H|mm|m|ss|s";
    l.formatArr = function(e) { return (e || "").match(new RegExp(D + "|.", "g")) || [] }, T.isLeapYear = function(e) { return e % 4 === 0 && e % 100 !== 0 || e % 400 === 0 }, T.prototype.config = { type: "date", range: !1, format: "yyyy-MM-dd", value: null, isInitValue: !0, min: "1900-1-1", max: "2099-12-31", trigger: "click", show: !1, showBottom: !0, isPreview: !0, btns: ["clear", "now", "confirm"], lang: "cn", theme: "default", position: null, calendar: !1, mark: {}, zIndex: null, done: null, change: null }, T.prototype.lang = function() {
        var e = this,
            t = e.config,
        ...
        a.elem = lay(a.elem), a.eventElem = lay(a.eventElem), a.elem[0] && (t.rangeStr = a.range ? "string" == typeof a.range ? a.range : "-" : "", a.range && a.range.constructor === Array && (t.rangeElem = [lay(a.range[0]), lay(a.range[1])]), i[a.type] || (e.console && console.error && console.error("laydate type error:'" + a.type + "' is not supported"), a.type = "date"), a.format === i.date && (a.format = i[a.type] || i.date), t.format = l.formatArr(a.format), t.EXP_IF = "", t.EXP_SPLIT = "", lay.each(t.format, function(e, a) {
            var n = new RegExp(D).test(a) ? "\\d{" + function() { return new RegExp(D).test(t.format[0 === e ? e + 1 : e - 1] || "") ? /^yyyy|y$/.test(a) ? 4 : a.length : /^yyyy$/.test(a) ? "1,4" : /^y$/.test(a) ? "1,308" : "1,2" }() + "}" : "\\" + a;
        ...
        var e = this,
            ...
            a = e.lang(),
            n = "static" === t.position,
            l = e.elem = lay.elem("div", { id: e.elemID, "class": ["layui-laydate", t.range ? " layui-laydate-range" : "", n ? " " + m : "", t.theme && "default" !== t.theme && !/^#/.test(t.theme) ? " laydate-theme-" + t.theme : ""].join("") }),
            r = e.elemMain = [],
            o = e.elemHeader = [],
            s = e.elemCont = [],
            y = e.table = [],
        ...
        if (t.zIndex && (l.style.zIndex = t.zIndex), lay.each(new Array(2), function(e) {
                ...
                var n = lay.elem("div", { "class": "layui-laydate-header" }),
                    ...
                    m = lay.elem("thead"),
                    c = lay.elem("tr");
                lay.each(i, function(e, t) { n.appendChild(t) }), m.appendChild(c), lay.each(new Array(6), function(e) {
                    var t = d.insertRow(0);
            ...
            }()), lay.each(r, function(e, t) { l.appendChild(t) }), t.showBottom && l.appendChild(d), /^#/.test(t.theme)) {
        ...
        return a[0] ? (a.hasClass(m) || t.checkDate(function() { a.remove() }), t) : t
    ...
    }, T.prototype.getAsYM = function(e, t, a) { return a ? t-- : t++, t < 0 && (t = 11, e--), t > 11 && (t = 0, e++), [e, t] }, T.prototype.systemDate = function(e) { var t = e || new Date; return { year: t.getFullYear(), month: t.getMonth(), date: t.getDate(), hours: e ? e.getHours() : 0, minutes: e ? e.getMinutes() : 0, seconds: e ? e.getSeconds() : 0 } }, T.prototype.checkDate = function(e) {
        var t, a, n = this,
            l = (new Date, n.config),
            r = n.lang(),
            o = l.dateTime = l.dateTime || n.systemDate(),
            s = n.bindElem || l.elem[0],
            y = (n.isInput(s) ? "val" : "html", function() { if (n.rangeElem) { var e = [n.rangeElem[0].val(), n.rangeElem[1].val()]; if (e[0] && e[1]) return e.join(" " + n.rangeStr + " ") } return n.isInput(s) ? s.value : "static" === l.position ? "" : lay(s).attr("lay-date") }()),
            m = function(e) { e.year > d[1] && (e.year = d[1], a = !0), e.month > 11 && (e.month = 11, a = !0), e.hours > 23 && (e.hours = 0, a = !0), e.minutes > 59 && (e.minutes = 0, e.hours++, a = !0), e.seconds > 59 && (e.seconds = 0, e.minutes++, a = !0), t = i.getEndDate(e.month + 1, e.year), e.date > t && (e.date = t, a = !0) },
            c = function(e, t, i) {
        ...
        u(), "string" == typeof y && y ? n.EXP_IF.test(y) ? l.range ? (y = y.split(" " + n.rangeStr + " "), lay.each([l.dateTime, n.endDate], function(e, t) { c(t, y[e], e) })) : c(o, y) : (n.hint(r.formatError[0] + (l.range ? l.format + " " + n.rangeStr + " " + l.format : l.format) + r.formatError[1]), a = !0) : y && y.constructor === Date ? l.dateTime = n.systemDate(y) : (l.dateTime = n.systemDate(), delete n.startTime, delete n.endDate, u(), delete n.endTime),
            function() {
                if (n.rangeElem) {
        ...
        var i, l = this,
            ...
            d = lay.extend({}, s, t || {});
        return lay.each({ now: d, min: r.min, max: r.max }, function(e, t) { o[e] = l.newDate(lay.extend({ year: t.year, month: t.month, date: t.date }, function() { var e = {}; return lay.each(n, function(a, n) { e[n] = t[n] }), e }())).getTime() }), i = o.now < o.min || o.now > o.max, e && e[i ? "addClass" : "removeClass"](y), i
        ...
        return m.year < d[0] && (m.year = d[0], o.hint(u.invalidDate)), m.year > d[1] && (m.year = d[1], o.hint(u.invalidDate)), o.firstDate || (o.firstDate = lay.extend({}, m)), c.setFullYear(m.year, m.month, 1), n = c.getDay(), l = i.getEndDate(m.month || 12, m.year), r = i.getEndDate(m.month + 1, m.year), lay.each(p, function(e, t) {
            var a = [m.year, m.month],
                i = 0;
            t = lay(t), t.removeAttr("class"), e < n ? (i = l - n + e, t.addClass("laydate-day-prev"), a = o.getAsYM(m.year, m.month, "sub")) : e >= n && e < r + n ? (i = e - n, i + 1 === m.date && t.addClass(s)) : (i = e - r - n, t.addClass("laydate-day-next"), a = o.getAsYM(m.year, m.month)), a[1]++, a[2] = i + 1, t.attr("lay-ymd", a.join("-")).html(a[2]), o.mark(t, a).limit(t, { year: a[0], month: a[1] - 1, date: a[2] }, e)
        ...
        var a = this,
            ...
            o = lay.elem("ul", { "class": c + " " + { year: "laydate-year-list", month: "laydate-month-list", time: "laydate-time-list" }[e] }),
            d = a.elemHeader[t],
            m = lay(d[2]).find("span"),
            u = a.elemCont[t || 0],
            h = lay(u).find("." + c)[0],
        ...
        if (D[0] < 1 && (D[0] = 1), "year" === e) {
            ...
            var C = function() {
                lay(o).find("ol").each(function(e, n) {
                    lay(n).find("li").each(function(n, i) {
                        a.limit(lay(i), [{ hours: n }, { hours: a[w].hours, minutes: n }, { hours: a[w].hours, minutes: a[w].minutes, seconds: n }][e], t, [
                            ["hours"],
                            ["hours", "minutes"],
            ...
            n.range ? a[w] || (a[w] = "startTime" === w ? i : a.endDate) : a[w] = i, lay.each([24, 60, 60], function(e, t) {
                var n = lay.elem("li"),
                    i = ["<p>" + l.time[e] + "</p><ol>"];
                lay.each(new Array(t), function(t) { i.push("<li" + (a[w][x[e]] === t ? ' class="' + s + '"' : "") + ">" + lay.digit(t, 2) + "</li>") }), n.innerHTML = i.join("") + "</ol>", o.appendChild(n)
            }), C()
        }
            ...
            var I = lay.elem("span", { "class": p }),
                k = function() {
                    lay(o).find("ol").each(function(e) {
                        var t = this,
                            n = lay(t).find("li");
                        t.scrollTop = 30 * (a[w][x[e]] - 2), t.scrollTop <= 0 && n.each(function(e, a) { if (!lay(this).hasClass(y)) return t.scrollTop = 30 * (e - 2), !0 })
                    })
                },
                b = lay(d[2]).find("." + p);
        ...
        var e = this;
        e.config;
        lay.each(e.elemCont, function(t, a) { lay(this).find("." + c).remove(), lay(e.elemMain[t]).removeClass("laydate-ym-show laydate-time-show") }), lay(e.elem).find("." + p).remove()
        ...
        if (t.isPreview) {
            ...
            a.html(n).css({ color: "#5FB878", "font-size": "14px;" }), setTimeout(function() { a.css({ color: "#666", "font-size": "12px;" }) }, 300)
        }
        ...
        var a = this,
            ...
            r = "static" === n.position,
            o = {
                datetime: function() { lay(e).hasClass(y) || (a.list("time", 0), n.range && a.list("time", 1), lay(e).attr("lay-type", "date").html(a.lang().dateTips)) },
                ...
                confirm: function() {
                    if (n.range) { if (lay(e).hasClass(y)) return a.hint("time" === n.type ? i.timeout.replace(/\u65e5\u671f/g, "\u65f6\u95f4") : i.timeout) } else if (lay(e).hasClass(y)) return a.hint(i.invalidDate);
    ...
    }, l.that = {}, l.getThis = function(e) { var t = l.that[e]; return t || hint.error(e ? r + " instance with ID '" + e + "' not found" : "ID argument required"), t }, a.run = function(t) {
        ...
        b = {
            tabClick: function(t, a, s, o) {
                ...
                var r = s || i(this),
                    ...
                    d = r.find("a"),
                    y = c.attr("lay-filter");
                "javascript:;" !== d.attr("href") && "_blank" === d.attr("target") || (r.addClass(l).siblings().removeClass(l), u.eq(a).addClass(n).siblings().removeClass(n)), layui.event.call(this, e, "tab(" + y + ")", { elem: c, index: a })
            },
                ...
                nav: function() {
                    var t = 200,
                        ...
                        C = function(l, o, r) {
                            ...
                            } else h.addClass(p), h.hasClass(y) && h.css({ left: -(h.outerWidth() - c.width()) / 2 }), h[0] ? l.css({ left: l.position().left + l.width() / 2, width: 0, opacity: 0 }) : l.css({ left: c.position().left + parseFloat(c.css("marginLeft")), top: c.position().top + c.height() - l.height() }), e[r] = setTimeout(function() { l.css({ width: h[0] ? 0 : c.width(), opacity: h[0] ? 0 : 1 }) }, a.ie && a.ie < 10 ? 0 : t), clearTimeout(v[r]), "block" === h.css("display") && clearTimeout(s[r]), s[r] = setTimeout(function() { h.addClass(n), c.find("." + f).addClass(f + "d") }, 300)
                        };
                    i(o + l).each(function(a) {
                        var l = i(this),
                            o = i('<span class="' + c + '"></span>'),
                            y = l.find("." + r);
                        l.find("." + c)[0] || (l.append(o), (l.hasClass(u) ? y.find("dd,>." + m) : y).on("mouseenter", function() { C.call(this, o, l, a) }).on("mouseleave", function() { l.hasClass(u) ? o.css({ height: 0, opacity: 0 }) : (clearTimeout(s[a]), s[a] = setTimeout(function() { l.find("." + d).removeClass(n), l.find("." + f).removeClass(f + "d") }, 300)) }), l.on("mouseleave", function() { clearTimeout(e[a]), v[a] = setTimeout(function() { l.hasClass(u) || o.css({ width: 0, left: o.position().left + o.width() / 2, opacity: 0 }) }, t) })), y.find("a").each(function() {
                            var t = i(this),
            ...
            d = {
                            ...
                            if (!u) {
                                ...
                                var T = function(e, i, a) {
                                    ...
                                    q = function(e) {
                                        var t = this.value,
                                            i = e.keyCode;
                                        return 9 !== i && 13 !== i && 37 !== i && 38 !== i && 39 !== i && 40 !== i && (T(t, function(e) { e ? g.find("." + r)[0] || g.append('<p class="' + r + '">\u65e0\u5339\u914d\u9879</p>') : g.find("." + r).remove() }, "keyup"), "" === t && g.find("." + r).remove(), void $())
                                    };
                        ...
                        var d = l.next("." + u[0]),
                            f = t(['<div class="layui-unselect ' + u[0], n.checked ? " " + u[1] : "", o ? " layui-checkbox-disbaled " + c : "", '"', r ? ' lay-skin="' + r + '"' : "", ">", function() {
                                var e = n.title.replace(/\s/g, ""),
                                    t = { checkbox: [e ? "<span>" + n.title + "</span>" : ""].join(""), _switch: "<em>" + ((n.checked ? s[0] : s[1]) || "") + "</em><i></i>" };
                ...
                radio: function() {
                    ...
                    a.each(function(a, l) {
                        ...
                        if ("string" == typeof r.attr("lay-ignore")) return r.show();
                        s[0] && s.remove();
                        var u = t(['<div class="layui-unselect ' + e, l.checked ? " " + e + "ed" : "", (o ? " layui-radio-disbaled " + c : "") + '">', '<i class="layui-anim layui-icon">' + i[l.checked ? 0 : 1] + "</i>", "<div>" + function() { var e = l.title || ""; return "string" == typeof r.next().attr("lay-radio") && (e = r.next().html()), e }() + "</div>", "</div>"].join(""));
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
    ...
    I.prototype.config = { limit: 10, loading: !0, cellMinWidth: 60, defaultToolbar: ["filter", "exports", "print"], autoSort: !0, text: { none: "\u65e0\u6570\u636e" } }, I.prototype.render = function() {
        ...
        }, d.reload = function(e, t, i) { var a = s(e); if (a) { var l = c.that[e]; return l.reload(t, i), c.call(l) } }, d.render = function(e) { var t = new I(e); return c.call(t) }, d.clearCacheKey = function(e) {
